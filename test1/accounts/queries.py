...
# {{ }} -> pass data through var & other dynamic ways
...
customerByName = Customer.objects.get(name='test3') #can return only one item. drawback. 

#***(5)Returns single customer by name
customerById = Customer.objects.get(id=4) #resolves the clashes, if 2 customers have same name
...
#if no filter is given, then filter() behaves as all() method
